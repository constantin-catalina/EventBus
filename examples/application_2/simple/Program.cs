...
namespace assignment_2_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BasicEventBus.Instance.Subscribe(typeof(SportsEvent), person1);
            BasicEventBus.Instance.Subscribe(typeof(CultureEvent), person1);
            BasicEventBus.Instance.Subscribe(typeof(PoliticsEvent), person1);
            BasicEventBus.Instance.Subscribe(typeof(CultureEvent), person2 );
            ...
            BasicEventBus.Instance.Unsubscribe(typeof(CultureEvent), person1);
