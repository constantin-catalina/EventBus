...
namespace assignment_2_2_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HandlerEventBus.Instance.Subscribe(person1, nameof(Person.HandleSportsEvent), typeof(SportsEvent));
            HandlerEventBus.Instance.Subscribe(person1, nameof(Person.HandleCultureEvent), typeof(CultureEvent));
            HandlerEventBus.Instance.Subscribe(person1, nameof(Person.HandlePoliticsEvent), typeof(PoliticsEvent));
            HandlerEventBus.Instance.Subscribe(person2, nameof(Person.HandleCultureEvent), typeof(CultureEvent));
            ...
            HandlerEventBus.Instance.Unsubscribe(person1, typeof(CultureEvent));
